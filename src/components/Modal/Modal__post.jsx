...
function Modal({onClose,setData}){
...
return (
    <div ref={modalRef} onClick={closeModal} className=' absolute inset-0  w-full h-[4000px]  bg-black bg-opacity-30 backdrop-blur-sm flex justify-center '>
